    ...
    //alert("focusDetailRowCheckBoxSelect called");
     if(obj)
     {
        ...
        if(objTbl)
        {
            ...
            //Tracker#:26982 - In Quantity by delivery screen check box was not selecting if the user clicked on editable fields 
            obj = objTbl.rows[repeatInd];
...
function _showSmartTagView(htmlfldName, objImg, tagDocId,tagDocVwId,custom,keyInfo,actCompId, showProcessingBar)
	{
	    ...
	    if (showProcessingBar == null || typeof(showProcessingBar) == 'undefined')
		{
	    ...
	    if(objAjax)
	    {
	        ...
	        objAjax.showProcessingBar(showProcessingBar);	    	
