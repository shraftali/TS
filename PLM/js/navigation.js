...
function getActionUrl(docViewId){
	...
	//Tracker#:26976 Quantities By Delivery 
	else if (docViewId == "189" || docViewId == "190")
	{
		return "quantitiesbydelivery.do";
	}
	else if (docViewId == "6301" || docViewId == "6302")
	{
		return "customerinvoice.do";
	}
	else if (docViewId == "6304")
	{
		return "customerinvoiceoverview.do";
	}
}
/**
